...
smiData.Solid(1).mass = 0.24848998364380978;  % kg
smiData.Solid(1).CoM = [52.370056106902119 104.82163713414771 160.98321593138306];  % mm
smiData.Solid(1).MoI = [178.93800905743262 791.70857614259387 717.1354273260506];  % kg*mm^2
smiData.Solid(1).PoI = [0.037412361944592513 -0.031056052612829226 4.1158556754735551];  % kg*mm^2
smiData.Solid(1).color = [0.792156862745098 0.81960784313725488 0.93333333333333335];
smiData.Solid(1).opacity = 1;
smiData.Solid(1).ID = 'Jeep body part*:*Default';

%Inertia Type - Custom
%Visual Properties - Simple
smiData.Solid(2).mass = 0.014289563528688412;  % kg
smiData.Solid(2).CoM = [2.1435581243893251 13.764546861724364 18.705039547638673];  % mm
smiData.Solid(2).MoI = [1.3560147526532491 0.96948621607226881 0.96948609758492843];  % kg*mm^2
smiData.Solid(2).PoI = [1.026130475033749e-07 3.0470481678421356e-07 -1.7592140811897729e-07];  % kg*mm^2
smiData.Solid(2).color = [0.792156862745098 0.81960784313725488 0.93333333333333335];
smiData.Solid(2).opacity = 1;
smiData.Solid(2).ID = 'wheel complete part*:*Default';
